...
export const StudentDashboard: React.FC = () => {
  ...
  const enrolledCourses = [
    { code: 'CS 101', name: 'Introduction to Programming', instructor: 'Dr. John Smith', schedule: 'MWF 9:00 AM', attendance: 92 },
    { code: 'CS 201', name: 'Data Structures', instructor: 'Dr. Jane Doe', schedule: 'TTh 11:00 AM', attendance: 88 },
    { code: 'MATH 301', name: 'Discrete Mathematics', instructor: 'Dr. Bob Wilson', schedule: 'MWF 2:00 PM', attendance: 95 },
  ];

  const recentAttendance = [
    { course: 'CS 101', date: '2024-01-15', status: 'Present', time: '9:05 AM' },
    { course: 'CS 201', date: '2024-01-14', status: 'Present', time: '11:02 AM' },
    { course: 'MATH 301', date: '2024-01-13', status: 'Present', time: '2:01 PM' },
